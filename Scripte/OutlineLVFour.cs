...
public class OutlineLVFive : MonoBehaviour
{
    ...
    void Update()
    {
        foreach (GameObject obj in allObjects)
        {
            ...
            if (obj.CompareTag("Trash") || obj.CompareTag("Trash2") || obj.CompareTag("Trash3") || obj.CompareTag("Trash4"))
            {
    ...
    private void UpdateObjectList()
    {
        ...
        string[] tags = { "Trash", "Trash2", "Trash3" ,"Trash4" };
